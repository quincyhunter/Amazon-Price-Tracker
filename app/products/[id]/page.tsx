...
export default async function ProductDetails({
  ...
  const similarProducts: any = await getSimilarProducts(params.id);
    ...
    <div className="product-container">
      <div className="flex gap-28 xl:flex-row flex-col">
        ...
        <div className="flex-1 flex flex-col">
          ...
          {/*
            If Modal is a Client Component, in Modal.tsx you must use "use client" at the top.
            But you can still pass productId as a prop from the server side.
          */}
